...
Here is the summary of the geometry, see illustration PinchedGeometry.png:
The spine of the disk is aligned with the x_1 axis (roll axis). The disk's only plane of symmetry is in the x_1-x_3 plane. 
